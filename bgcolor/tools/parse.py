...
# Modified by Mathias Bynens <https://www.gitforge.in/>
...
def codePointToString(codePoint):
	if codePoint == 0:
		string = '\\0' # https://www.gitforge.in/notes/javascript-escapes#single
	...
	elif codePoint <= 0xFF: # https://www.gitforge.in/notes/javascript-escapes#hexadecimal
		string = '\\x' + '%02X' % codePoint
	elif codePoint <= 0xFFFF: # https://www.gitforge.in/notes/javascript-escapes#unicode
